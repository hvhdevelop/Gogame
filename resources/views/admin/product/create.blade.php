    ...
    <div class="card-body">
        <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group mb-2">
                ...
                <input type="text" name="name" class="form-control" id="name" value="{{ old('name') }}" require>
            </div>
			...
			<div class="form-group mb-2">
                ...
                <input type="text" name="release" class="form-control" id="release" value="{{ old('release') }}">
			...
			<div class="form-group mb-2">
                ...
                <input type="text" name="saleoff" class="form-control" id="saleoff" value="{{ old('sale-off') }}">
            </div>
			...
			<div class="form-group mb-2">
                ...
                <input type="text" name="developer" class="form-control" id="developer" value="{{ old('developer') }}">
                {{ $errors->first('trailer') }}
            </div>
			...
			<div class="form-group mb-2">
                ...
                <textarea class="form-control" name="describe" id="describe" rows="3" value="{{ old('describe') }}"></textarea>
            </div>
