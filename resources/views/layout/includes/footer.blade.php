...
<footer class="footer">
			...
			<div class="row">
					...
					<div class="footer__navs">
						...
						<div class="footer__nav footer__nav--2">
							...
							<nav class="footer__list footer__list--double">
								...
								<a href="https://starcraft2.com/en-us/" target="_blank">StarCraft 2</a>
								<a href="https://store.steampowered.com/app/730/CounterStrike_Global_Offensive/?l=vietnamese" target="_blank">CS:GO</a>
								<a href="https://lienminh.garena.vn/" target="_blank">League of Legends</a>
								<a href="https://store.steampowered.com/app/578080/PLAYERUNKNOWNS_BATTLEGROUNDS/" target="_blank">Battlegrounds</a>
							</nav>
				...
				<div class="col-12">
					<div class="footer__wrap">
						...
						<span class="footer__copyright">© GoGame, 2020—2021 <br> Create by Hồ Viết Hùng</span>
					</div>
				</div>
			</div>
		</div>
	...
	<script src="{{ url('/') }}/js/jquery.mCustomScrollbar.min.js"></script>
