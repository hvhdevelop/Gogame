				...
				<div class="col-12">
					<div class="section__wrap">
						...
						<ul class="breadcrumb">
							...
							<li class="breadcrumb__item breadcrumb__item--active">Phản hồi</li>
						</ul>
						<!-- end breadcrumb -->
					</div>
				</div>
			...
			<div class="row">
				<div class="col-12 col-md-7 col-xl-8">
					<div class="row">
						<!-- section title -->
						<div class="col-12">
							<h2 class="section__title">Gửi e-mail phản hồi</h2>
						</div>
						<!-- end section title -->

						<div class="col-12">
							<form action="#" class="form form--contacts">
								<input type="text" class="form__input" placeholder="Tên của bạn">
								<input type="text" class="form__input" placeholder="Địa chỉ e-mail">
								<input type="text" class="form__input" placeholder="Vấn đề">
								<textarea name="text" class="form__textarea" placeholder="Viết phản hồi của bạn"></textarea>
				...
				<div class="col-12 col-md-5 col-xl-4">
					<div class="row">
						<!-- section title -->
						<div class="col-12">
							<h2 class="section__title">Thông tin địa chỉ</h2>
						</div>
						<!-- end section title -->

						<div class="col-12">
							<p class="section__text section__text--mt">Nếu có thắc mắc về sản phẩm hay có khiếu nại về đơn hàng xin hãy gửi phản hồi đến chúng tôi để được trợ giúp.</p>

							<ul class="contacts__list">
								<li><a href="#">Phone: 0812300227</a></li>
								<li><a href="#">E-mail: hoviethung10b2@gmail.com</a></li>
								<li><a href="#" class="open-map">Address: 133 Lý thường Kiệt, Đông Hà, Quảng Trị</a></li>
							</ul>
